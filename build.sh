...
docker login -u navin136 -p $PASSWD || { echo "Docker Login failed" && msg <b>Docker Login Failed<b/> && exit 1; }
docker build . -t navin136/builder || { echo "Docker Build failed" && msg <b>Docker Build Failed<b/> && exit 1; }
